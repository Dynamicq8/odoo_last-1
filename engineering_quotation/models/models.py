...
WORKFLOW_TEMPLATES = {
    'res_new': [
        ...
        {'code': 'rn_5_4', 'name': '4- إنهاء الإشراف', 'stage': 'المرحلة الخامسة', 'role': 'secretary_id', 'depends_on': ['rn_5_2']}, # Modified dependency
    ],
    ...
    'non_res_new': [
        ...
        {'code': 'nrn_5_3', 'name': '4- إنهاء الإشراف', 'stage': 'المرحلة الخامسة', 'role': 'secretary_id', 'depends_on': ['nrn_5_2']}, # Modified dependency
    ],
    ...
    'non_res_add': [
        ...
        {'code': 'nra_5_2', 'name': '3- إنهاء الإشراف', 'stage': 'المرحلة الخامسة', 'role': 'secretary_id', 'depends_on': ['nra_5_1']}, # Modified dependency
    ],
